...
<div class="sidebar d-flex flex-column justify-content-between p-4" id="sidebarMenu">
    <div>
        <div class="d-flex align-items-center mb-4 px-2">
            ...
            <div>
                ...
                <small class="text-muted" style="font-size: 11px;">Autonomous POS v5.0</small>
            </div>
        </div>
    ...
    <div class="p-3 rounded-lg border border-secondary bg-dark text-center shadow-sm">
        <div class="d-flex align-items-center justify-content-center mb-1">
            ...
            <span class="text-white small font-weight-bold">Neural Engine Active</span>
        </div>
        <small class="text-muted" style="font-size: 10px;">Enterprise Tier Ready</small>
    </div>
</div>
